  ...
  return (
    <>
      ...
      {showTooltip && explanation && (
        <EdgeLabelRenderer>
          <div
            className="absolute pointer-events-none px-3 py-2 rounded-lg bg-surface border border-border shadow-elevated max-w-[280px] z-50"
            style={{
              transform: `translate(-50%, -50%) translate(${labelX}px,${labelY}px)`,
            }}
          >
            <p className="text-xs text-charcoal/80 leading-relaxed">{explanation}</p>
            {verified && (
