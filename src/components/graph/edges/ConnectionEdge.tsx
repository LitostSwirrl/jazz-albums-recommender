  ...
  return (
    <>
      ...
      {showTooltip && explanation && (
        <EdgeLabelRenderer>
          <div
            className="absolute pointer-events-none px-3 py-2 rounded-lg bg-zinc-900 border border-zinc-700 shadow-xl max-w-[280px] z-50"
            style={{
          ...
          >
            ...
            {verified && (
              <span className="inline-flex items-center gap-1 mt-1 text-emerald-500 text-[10px]">
